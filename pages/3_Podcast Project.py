...
with st.container():
    ...
    with text_column:
        ...
        st.write("Review my [product proposal]"
                 "(https://docs.google.com/document/d/1vDb1Sjt3bEbyKkZzqr4WmFqzDMEAxsDINTeFEkJDUeM/edit) or see more below.")
        st.write("Check out my [marking launch campaign]"
                 "(https://docs.google.com/document/d/1EtkHKPGVMTpaGLwpb9LE22IvNv5XRhipm8OIGtWdypQ/edit?usp=sharing)")
